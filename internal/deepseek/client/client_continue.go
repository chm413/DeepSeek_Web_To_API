...
var defaultAutoContinueLimit = func() int {
	if v := strings.TrimSpace(os.Getenv("DEEPSEEK_WEB_TO_API_AUTO_CONTINUE_ROUNDS")); v != "" {
...
// AUTO_CONTINUE), deepseek-web-to-api will automatically call the DeepSeek continue
